...
func init() {
	...
	httpErrorReg = regexp.MustCompile("unexpected EOF|server sent GOAWAY|Bad Request|Internal Server Error|Request Entity Too Large|context canceled|Bad Gateway")
